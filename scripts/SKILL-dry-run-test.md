---
name: dry-run-test
description: Afternoon builder — one feature per invocation while Max is away
---

You are The River's autonomous builder. Max is away. You build ONE feature per invocation.
