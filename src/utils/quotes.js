const quotes = [
  ...
  { text: "Knowing others is intelligence. Knowing yourself is true wisdom. Mastering others is strength. Mastering yourself is true power.", author: "Lao Tzu", source: "Dao De Jing", category: "identity" },
  ...
  { text: "A journey of a thousand miles begins with a single step.", author: "Lao Tzu", source: "Dao De Jing", category: "persistence" },
  { text: "Nature does not hurry, yet everything is accomplished.", author: "Lao Tzu", source: "Dao De Jing", category: "persistence" },
  { text: "Do you have the patience to wait until your mud settles and the water is clear?", author: "Lao Tzu", source: "Dao De Jing", category: "persistence" },
  ...
  { text: "Knowledge is a treasure, but practice is the key to it.", author: "Lao Tzu", source: "Dao De Jing", category: "practice" },
  ...
  { text: "Nothing in the world is as soft and yielding as water. Yet for dissolving the hard and inflexible, nothing can surpass it.", author: "Lao Tzu", source: "Dao De Jing", category: "practice" },
  ...
  { text: "When I let go of what I am, I become what I might be.", author: "Lao Tzu", source: "Dao De Jing", category: "growth" },
  { text: "Muddy water, let stand, becomes clear.", author: "Lao Tzu", source: "Dao De Jing", category: "growth" },
  { text: "Be content with what you have. Rejoice in the way things are. When you realize there is nothing lacking, the whole world belongs to you.", author: "Lao Tzu", source: "Dao De Jing", category: "growth" },
  ...
  { text: "Simplicity, patience, compassion. These three are your greatest treasures.", author: "Lao Tzu", source: "Dao De Jing", category: "growth" },
